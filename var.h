...
extern void   var_set_obj (var* o, text_t k, pobj_t a);
extern void   var_set_bin (var* o, text_t k, size_t s, data_t a CAN_NULL);
extern void   var_set_str (var* o, text_t k, text_t a CAN_NULL);
extern void   var_set_ptr (var* o, text_t k, uint_t t, pbuf_t p);
extern void   var_set_char(var* o, text_t k, utf8_t v);
extern void   var_set_num (var* o, text_t k, real_t v);
extern void   var_set_int (var* o, text_t k, ulli_t v);
extern void   var_set_bool(var* o, text_t k, bool   v);

extern pobj_t var_get_obj(var* o, text_t k);
extern cap*   var_get_bin(var* o, text_t k);
extern str*   var_get_str(var* o, text_t k);
extern val*   var_get_val(var* o, text_t k);
