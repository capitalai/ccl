...
extern pod* new_pod_c(
  pod_comp_f         f_comp,
  pod_find_f         f_find,
  pod_push_f* f_push CAN_NULL,
  pod_pull_f* f_pull CAN_NULL,
  parg_t p_bind      CAN_NULL,
...
extern size_t
  pod_hoop(pod* o, pod_loop_f f, data_t start CAN_NULL, data_t stop CAN_NULL, parg_t extra CAN_NULL);  // loop backward
